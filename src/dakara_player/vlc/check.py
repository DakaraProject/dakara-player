...
def is_vlc_available() -> bool:
    ...
    This is trickier than it sounds, as on some machine, importing `vlc`
    ...
    servers?), creating objects is fine, but they are `None` (this is the case
    for `vlc.Instance()` by instance).
