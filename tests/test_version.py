...
class CheckVersionTestCase(TestCase):
    ...
    def test_check_version_release(self):
        ...
        """
        with self.assertLogs("dakara_player_vlc.version", "DEBUG") as logger:
            with patch.multiple(
                "dakara_player_vlc.version", __version__="0.0.0", __date__="1970-01-01"
            ):
                check_version()
        ...
        self.assertListEqual(
            logger.output,
            ["INFO:dakara_player_vlc.version:" "Dakara player 0.0.0 (1970-01-01)"],
        )
    ...
    def test_check_version_non_release(self):
        ...
        self.assertListEqual(
            logger.output,
            [
                "INFO:dakara_player_vlc.version:"
                "Dakara player 0.1.0-dev (1970-01-01)",
                "WARNING:dakara_player_vlc.version:"
